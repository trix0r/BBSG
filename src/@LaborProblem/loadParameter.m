...
self.stateNames  = {'normW'};
self.discreteStateNames = {'Alive'};
self.policyNames = {'normS', 'normB'};
...
%% grids
% wealth grid
self.Grid.lowerBounds = 0.02;
self.Grid.upperBounds = 100;
